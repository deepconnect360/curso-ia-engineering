...
const API_PROXY_URL = "https://curso-ia-engineering.vercel.app/api/chat";
...
const WEEKS = [
  {
    ...
    locked: false,
    summary:
      "Arrancas hablando con un agente y construyes tu primer proyecto. Entendemos qué tan potentes son estas herramientas y sus límites reales.",
    objectives: [
...
Empieza saludando al alumno y preguntando: ¿qué quieres construir esta semana? Una idea, un proyecto, lo que sea. Nosotros lo hacemos realidad.`,
  },
  {
    ...
    locked: false,
    summary:
      "Dejamos el Vibe Coding atrás. Pensamos como ingenieros: reglas, casos de uso, historias de usuario, roles y límites. Repositorios y herramientas profesionales.",
    objectives: [
...
Empieza preguntando en qué proyecto está trabajando y qué problema tuvo la semana pasada que se hubiera evitado con más estructura.`,
  },
  {
    ...
    locked: false,
    summary:
      "Auditas lo que produce la IA: detectas fallos, alucinaciones, atajos y deuda técnica. Montas pruebas. Introduces embeddings y búsqueda semántica.",
    objectives: [
...
Empieza preguntando: ¿alguna vez la IA te ha entregado algo que parecía correcto pero estaba mal? Cuéntame qué pasó.`,
  },
  {
    ...
    locked: false,
    summary:
      "Conceptos técnicos de una aplicación profesional: arquitecturas estándar, tecnologías web y bases de datos. Frontend, backend, API y datos.",
    objectives: [
...
Empieza con: Dibujemos juntos la arquitectura de tu proyecto actual. Dime qué has construido hasta ahora.`,
  },
  {
    ...
    locked: false,
    summary:
      "Tests, especificaciones, documentación y criterios de aceptación. Tu proyecto pasa de funcionar a ser sólido y mantenible.",
    objectives: [
...
Empieza preguntando: ¿tienes tests en tu proyecto? Si no, ¿qué parte te da más miedo que falle?`,
  },
  {
    ...
    locked: false,
    summary:
      "Conectas APIs, webhooks y bases de datos vectoriales. La IA empieza a trabajar sola en casos reales de tu proyecto.",
    objectives: [
...
Empieza con: ¿Qué tarea repetitiva en tu proyecto te gustaría que la IA hiciera sola?`,
  },
  {
    ...
    locked: false,
    summary:
      "Montas rutinas y flujos que actúan solos. Aprendes a aislarlos para evitar desastres y a verificar que cumplen lo que tienen que hacer.",
    objectives: [
...
Empieza con: Cuéntame el flujo agéntico que construiste la semana pasada. Lo auditamos juntos.`,
  },
  {
    ...
    locked: false,
    summary:
      "Sacas el proyecto de la demo: despliegue, datos, logs, backups, monitorización y control de errores para que aguante con usuarios reales.",
    objectives: [
...
Empieza con: ¿Tu proyecto funciona solo en tu máquina, o alguien más puede usarlo? Vamos a cambiarlo hoy.`,
  },
  {
    ...
    locked: false,
    summary:
      "Modelos open-weight: cómo funcionan, cómo se configuran, qué hardware necesitan. Aislamos datos confidenciales y sensibles.",
    objectives: [
...
Empieza con: ¿Tienes datos en tu proyecto que no deberían salir de tu máquina o de tu empresa? Vamos a identificarlos.`,
  },
  {
    ...
    locked: false,
    summary:
      "Optimizas contexto y costos. Proteges tu aplicación contra los vectores de ataque más comunes en sistemas de IA.",
    objectives: [
...
WEEKS.forEach((w) => {
  w.systemPrompt = w.systemPrompt + EVAL_PROTOCOL;
});
...
const DELIVERABLE = {
  ...
  intro:
    "Sales con un sistema de IA real, construido por ti y auditado por el experto. No una demo bonita: un proyecto que funciona de verdad, con criterio técnico detrás de cada decisión.",
  pillars: [
    {
...
const EXTRA_MODULE = {
  ...
  subtitle:
    "Aprende a programar para 2026 y más allá: en directo, con prioridad, para escribir y no solo auditar.",
  pitch:
    "No solo vienes a aprender a usar una IA. Vienes a entrenar criterio técnico: cómo decidir, probar, auditar y llevar un sistema con IA fuera de una demo bonita.",
  objectives: [
    {
    ...
    >
      ...
      {!editing &&
        (entries.length === 0 ? (
          ...
          >
            Sin registros todavía. El instructor añadirá un resumen fechado cada
            vez que te evalúe.
          </p>
        ) : (
          <div
              ...
              return (
                ...
                >
                  {e.header && (
                    ...
                    >
                      {i === 0 && (
                        <span style={{ color: accent || "#4F8EF7" }}>● </span>
                      )}
                      {e.header}
                    </p>
                  )}
      ...
      {!editing && (
        ...
        >
          Cada evaluación del instructor añade una entrada nueva arriba. El
...
export default function CursoIA() {
  ...
  const submitAccessCode = async () => {
    ...
    if (VALID_CODES.map((c) => c.toUpperCase()).includes(code)) {
      ...
      setCodeError(false);
      try {
        await storage.set(ACCESS_KEY, "granted");
      } catch (e) {
        /* ignore */
      }
    } else {
  ...
  const appendNote = (sessionId, resumen, verdict) => {
    ...
    setNotes((prev) => {
      ...
      if (
        existing.startsWith(`[${stamp} · ${tag}]`) &&
        existing.includes(resumen)
      ) {
        return prev;
      }
  ...
  const resetProgress = () => {
    if (
      !window.confirm(
        "¿Reiniciar todo el progreso? Se borrarán las aprobaciones, las conversaciones guardadas y las notas del especialista. Esta acción no se puede deshacer.",
      )
    )
      return;
    setCompleted({});
    ...
    storage
      .resetAll()
      .catch((err) => console.error("[curso-ia] Error al resetear:", err));
  };
  ...
  const printCertificate = () => {
    ...
    if (!win) {
      window.alert(
        "Permite las ventanas emergentes para descargar el certificado, o usa una captura de la vista.",
      );
      return;
    }
    const rows = weeksDone
      .map(
        (w) =>
    ...
    const extras = [
      ...
      completed["extra"]
        ? "Certificado · Programación en Python y JavaScript con IA"
        : null,
    ]
      .filter(Boolean)
      .map((t) => `<li>${t}</li>`)
    ...
    win.document
      .write(`<!doctype html><html lang="es"><head><meta charset="utf-8"><title>Certificado · ${certificateId}</title>
<style>
...
<script>setTimeout(function(){window.print();}, 600);</script>
  ...
  const fetchResponse = async (history, systemPrompt, userMsg) => {
      ...
      ? [
          {
            role: "user",
            content:
              "Empieza la sesión de esta semana. Salúdame y arranca con tu primera pregunta.",
          },
        ]
    ...
    try {
      ...
      const assistantText =
        data.content?.[0]?.text || "Error al obtener respuesta.";
      ...
      setMessages((prev) => [
        ...
        {
          role: "assistant",
          text: "Error de conexión. Verifica tu acceso a la API.",
        },
      ]);
    }
  ...
  const requestEvaluation = () => {
    ...
    setMessages((prev) => [
      ...
      {
        role: "user",
        text: "🎓 Solicité una evaluación de mi nivel.",
        isSystem: true,
      },
    ]);
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Introduce el código de acceso que recibiste al inscribirte para
            entrar al programa.
          </p>
          ...
          <div className={codeError ? "gate-shake" : ""}>
            ...
            {codeError && (
              ...
              >
                Código no válido. Revisa el que recibiste o contacta con
                soporte.
              </p>
            )}
          </div>
          ...
          >
            ¿No tienes código? El acceso se entrega al completar la inscripción
            del programa.
          </p>
        </div>
      </div>
    ...
    >
      ...
      {view === "home" && (
        ...
        >
          ...
          <div style={{ marginBottom: "48px" }}>
            ...
            >
              10 semanas. Desde tu primer prototipo hasta un sistema agéntico en
              producción, seguro y mantenible. Claude te acompaña como
              instructor técnico en cada sesión.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {completedCount} / {TOTAL_ITEMS} completado
                  {completedCount === 1 ? "" : "s"}
                </span>
              </div>
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                <button
                  onClick={() => {
                    if (
                      window.confirm(
                        "¿Cerrar el acceso? Tendrás que volver a introducir el código.",
                      )
                    )
                      lockAccess();
                  }}
          ...
          >
            ...
            <p
              style={{ fontSize: "13px", color: "#6B7A9E", lineHeight: "1.6" }}
            >
              <strong style={{ color: "#4F8EF7" }}>Cómo funciona:</strong> el
              curso es secuencial. En cada sesión el instructor te evalúa con
              preguntas reales y desbloquea la siguiente semana solo cuando
              demuestras dominio. Aprueba las 10 para acceder al entregable
              final. El módulo de programación está siempre disponible.
            </p>
          </div>
            ...
            >
              <div
                style={{
                  ...
                  height: "100%",
                  background:
                    "radial-gradient(circle at 80% 50%, rgba(232,93,117,0.12), transparent 70%)",
                }}
              />
              <div
                style={{
              ...
              <span
                style={{
                  fontFamily: "'JetBrains Mono', monospace",
                  fontSize: "12px",
                  color: isDeliverableUnlocked ? "#E85D75" : "#6B5560",
                }}
              >
            ...
            >
              <div
                style={{
                  ...
                  height: "100%",
                  background:
                    "radial-gradient(circle at 80% 50%, rgba(124,106,245,0.14), transparent 70%)",
                }}
              />
              <div
                style={{
        ...
        >
          ...
          <p
            style={{
              ...
              lineHeight: "1.75",
              marginBottom: "32px",
              borderLeft: `3px solid ${activeWeek.color}`,
              paddingLeft: "16px",
            }}
          >
            {activeWeek.summary}
          ...
          <div
            style={{
              background: completed[`week-${activeWeek.id}`]
          ...
          >
            ...
            <p
              style={{ fontSize: "13px", color: "#8A92AA", lineHeight: "1.6" }}
            >
              {completed[`week-${activeWeek.id}`] ? (
                <>
                  <strong style={{ color: "#2DD4A0" }}>Semana aprobada.</strong>{" "}
                  El instructor certificó que dominas estos objetivos.{" "}
                  {activeWeek.id < WEEKS.length
                    ? "La siguiente semana ya está desbloqueada."
                    : "Has completado el temario: el entregable final está disponible."}
                </>
              ) : (
                <>
                  <strong style={{ color: activeWeek.color }}>
                    Cómo se aprueba:
                  </strong>{" "}
                  el instructor te hará preguntas durante la sesión y
                  desbloqueará la siguiente semana solo cuando demuestres
                  dominio de los objetivos. Reintentos ilimitados, sin
                  penalización.
                </>
              )}
            </p>
      ...
      {view === "deliverable" && (
        ...
        >
          ...
          >
            ...
            >
              {completed["deliverable"]
                ...
                : "Auditar mi proyecto con el experto →"}
            </button>
            {completed["deliverable"] && (
              <span
                style={{
          ...
          >
            El auditor certifica tu proyecto cuando pase la revisión capa por
            capa. No es un clic: es su veredicto.
          </p>
          {!completed["deliverable"] && (
            <button
      ...
      {view === "stack" && (
        ...
        >
          ...
          >
            Un stack profesional completo: desde editores y agentes hasta
            modelos locales, bases vectoriales e infraestructura. El
            especialista añade las que tu proyecto necesite.
          </p>
          ...
          >
            ...
            >
              ...
              El stack se adapta a tu proyecto: no metemos tecnología por moda,
              sino la que resuelve tu caso real.
            </p>
          </div>
        </main>
      )}
            ...
            >
              {completed["extra"] ? (
                <>
                  ...
                  El instructor certificó que dominas los fundamentos para
                  escribir con criterio.
                </>
              ) : (
                <>
                  <strong style={{ color: "#7C6AF5" }}>
                    Cómo se certifica:
                  </strong>{" "}
                  el instructor te pedirá escribir, explicar y depurar código
                  real, y certificará tu dominio cuando lo demuestres. Este
                  módulo es libre: certificarlo no condiciona el resto del
                  curso, es tu señal de progreso. Reintentos ilimitados.
                </>
              )}
            </p>
          </div>
      ...
      {view === "certificate" && (
        ...
        >
          ...
          >
            <div
              style={{
                ...
                height: "4px",
                background:
                  "linear-gradient(90deg,#4F8EF7,#7C6AF5,#2DD4A0,#FF6B35,#C0392B)",
              }}
            />
            <p
              style={{
            ...
            >
              De Vibe Coding a<br />
              <span style={{ color: "#4F8EF7" }}>producción segura.</span>
            </h2>
            <p
              style={{
                fontSize: "14px",
            ...
            >
              Acredita la finalización del programa de Ingeniería de IA
              aplicada, evaluado y aprobado capa por capa.
            </p>
            ...
            <div>
              {WEEKS.filter((w) => completed[`week-${w.id}`]).map((w) => (
                ...
                >
                  ...
                  <span style={{ fontSize: "14px", color: "#B8C4D8", flex: 1 }}>
                    {w.title}
                  </span>
                  <span
                    style={{
            ...
            {(completed["deliverable"] || completed["extra"]) && (
              <>
                ...
                {completed["deliverable"] && (
                  ...
                  >
                    ✓ Entregable final · Proyecto auditado
                  </p>
                )}
                {completed["extra"] && (
                  <p
          ...
          >
            Se abrirá una ventana con el certificado lista para imprimir o
            guardar como PDF (Cmd/Ctrl + P).
          </p>
        </main>
      )}
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
              ...
              <button
                onClick={() => {
                  if (
                    window.confirm(
                      "¿Empezar esta sesión de nuevo? Se borrará la conversación guardada con el instructor (tu aprobación se mantiene).",
                    )
                  ) {
              ...
              <button
                onClick={() => {
                  ...
                  else if (activeWeek.label === "Entregable")
                    setView("deliverable");
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      borderRadius: "6px",
                      background:
                        msg.role === "assistant" ? activeWeek.color : "#1C2340",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      flexShrink: 0,
                  ...
                  <div
                    style={{
                      background:
                        msg.role === "assistant" ? "#0E1525" : "#141B2E",
          ...
          {justUnlocked && (
            <div
              style={{
                background:
                  "linear-gradient(135deg, rgba(45,212,160,0.12), rgba(79,142,247,0.10))",
            ...
            >
              ...
              <button
                onClick={() => {
                  if (justUnlocked.type === "week")
                    openWeekDetail(justUnlocked.week);
          ...
          {lastVerdict === "PENDIENTE" && !justUnlocked && (
            ...
            >
              ...
              >
                Aún no aprobada. Revisa el feedback del instructor y sigue
                practicando — tienes reintentos ilimitados.
              </p>
            </div>
          )}
          ...
          >
            ...
            >
              ...
              <button
                ...
                style={{
                  background:
                    input.trim() && !loading ? activeWeek.color : "#1C2340",
                  border: "none",
                  borderRadius: "6px",
                  width: "32px",
                  height: "32px",
